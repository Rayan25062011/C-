...
class Parser:
    ...
    def ParseFunctions(self, code: str) -> str:
        ...
        for line in code.splitlines():
            if "public static fn" in line and not self.IsInString("public static void", line):
                code = code.replace(line, line.replace("public static void", "def"))
        for line in code.splitlines():
            if "static fn" in line and not self.IsInString("static fn", line):
                code = code.replace(line, line.replace("static fn", "def"))
        for line in code.splitlines():
